...
const IndexRoute: React.FC<Props> = ({ products }) => {
  ...
  /* (Para ver que nos trae de productos) return <div>{JSON.stringify(products)}</div>; */
   /* LINEA 56 Le decimos que por cada elemento que haya en productos vamos a mostrar un stack (componente de chakra que te permite ubicar las cosas en una horientazión vertical, horizontal y el espacio entre los elementos sin tener espacio en ellos) */
